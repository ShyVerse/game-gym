...
GpuBuffer::GpuBuffer(WGPUBuffer buffer, uint64_t size) : buffer_(buffer), size_(size) {}
...
GpuBuffer::GpuBuffer(GpuBuffer&& other) noexcept : buffer_(other.buffer_), size_(other.size_) {
